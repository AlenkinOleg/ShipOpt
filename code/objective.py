...
def objective(StrawPitch = 1.7, OffsetLayer12 = 1.76/2, OffsetPlane12 = 1.76/4, DeltazLayer = 1.1,\
    ...
    #Run reconstruction
    os.system('source $SHIPSOFT/FairShipRun/config.sh; cd ../temp/; python2 $FAIRSHIP/Developments/track_pattern_recognition/RunPR.py -i ship.conical.Pythia8-TGeant4.root -g geofile_full.conical.Pythia8-TGeant4.root')

    #Get metrics from histograms
